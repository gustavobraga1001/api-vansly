...
let sut: GetRouteStudentUseCase

describe('Get Route Student Use Case', () => {
  beforeEach(() => {
    ...
    sut = new GetRouteStudentUseCase(
      routeRepository,
      stopsRepository,
  ...
  it('should be able to get a student route', async () => {
